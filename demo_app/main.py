...
def get_tools(llm):
    ...
    tools_data = {
        ...
        "Generate_DALL-E_Image": {
            "description": """Useful for generating DALL-E images for a story. The input to this tool should be a detailed specific prompt that DALL-E can use, including a detailed description of framing. The result of this tool should be a cinematic well framed image generated by DALL-E to represent what's happening in the story.
""",
